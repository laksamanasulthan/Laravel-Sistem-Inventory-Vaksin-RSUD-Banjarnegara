...
$response = $client->request('GET', '/api/apidbdua');
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="modal-dialog">
                            ...
                            <form action="aksi_tambah2.php" method="POST">
                                ...
                                <div class="form-group last mb-4">
                                    <label for="vak">Nama Vaksin</label>
                                    <input type="text" class="form-control"  name="vak">
                                </div>
                                <div class="form-group last mb-4">
                                    <label for="dis">Distributor</label>
                                    <input type="text" class="form-control"  name="dis">
                                </div>
                                <div class="form-group last mb-4">
                                    <label for="pasien">Kuantitas Pasien (Target)</label>
                                    <input type="text" class="form-control"  name="pasien">
                                </div>
                                <div class="form-group last mb-4">
                                    <label for="stok">Stok Pembelian</label>
                                    <input type="text" class="form-control"  name="stok">
                                </div>
                                <div class="form-group last mb-4">
                                    <label for="peta">Petunjuk</label>
                                    <input type="text" class="form-control"  name="peta">
                                </div>
                                <div class="form-group last mb-4">
                                    <label for="cost">Biaya Pengadaan</label>
                        ...
                        <div class="modal-dialog">
                            ...
                            <form action="aksi_update2.php" method="POST">
                                ...
                                <div class="form-group last mb-4">
                                    <label for="kwan">Kuantitas Pasien (Target)</label>
                                    <input type="text" class="form-control"  name="kwan">
                                </div>
                                <div class="form-group last mb-4">
                                    <label for="stok">Stok Pembelian</label>
                                    <input type="text" class="form-control"  name="stok">
                                        ...
                                        <?php
                                            ...
                                            foreach ($data_body as $data) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $data->targetpasien; ?></td>
                                                    <td><?php echo $data->stokpembelian; ?></td>
                                                    <td><?php echo $data->petunjuk; ?></td>
                                                    <td><?php echo $data->biayapengadaan; ?></td>
                                                    <td>
                                                    <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li><a class="dropdown-item" href="aksi_delete2.php?del=<?php echo $data->id; ?>">Delete</a></li>
                                                            </ul>
                                                            </div> 
                                                    </td>
                                                </tr>
